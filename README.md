...
Steam PC 单人买断方向的三国卡牌肉鸽。当前默认是 **v0.5.1 连锁冲分版**：六张选三张，通过武将、军宝、成长和战后随机整编，挑战递增的敌军目标。
...
这是可玩开发原型，尚未验证真人重复游玩的吸引力。本轮提高后半程目标并加入换牌/首牌兵种应对；数值仍待真人复测。Windows原生、五人试玩、正式美术、Steam商店与上传均未完成。
