...
当前新局包含12位活跃将星、5个槽、6种阵型、6类随机定向整编和8关征程。多位将星可以从对子、连阵、同兵种或最右牌发起“额外计分”，其余将星继续追击或响应，不限制固定流派。阵型倍率依次为×1、×2、×3、×4、×6、×10；第4关张宝与第8关张角是两阶段首领，八关通关后可保留构筑进入极限挑战。

马超追击、陆逊连营、稀有招募、结算后押分和单手纪录构成冲分循环。游戏内押分只使用本局分数，不涉及真钱。
