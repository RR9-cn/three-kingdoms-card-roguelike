...
Steam PC 单人买断方向的三国卡牌肉鸽。当前默认是 **v0.5.2 张角演出版**：六张选三张，通过武将、军宝、成长和战后随机整编，挑战递增的敌军目标。

先试「启程」→选关羽、周瑜或刘备→普通进军。每关胜后征募、整编、逛商店。支持1–6选牌、Enter出牌/下一手、自动存档与原生最小化暂停。

只想检查新版首领演出时，点击首页“演出试玩 · 直达张角”。它提供一套固定成型构筑并直接进入第8关，退出后恢复原征程，不写入正式存档。
...
22个组件、5个槽、4类随机正向整编、8关、开局选核心、逐步结算、即时预览、刷新/买卖/替换。每场胜利后可随机获得复制阵牌、升点、强化或牌型升级中的一项，也可跳过换3军资。默认随机种子，可输入 `forge-v051-7` 重玩本版通关测试种子；没有暗中保送奖励。

这是可玩开发原型，尚未验证真人重复游玩的吸引力。本轮为第8关张角加入 PixelLab 待机、受击、雷法变招与败亡动作，并配合暗场、雷光和受击反馈；张宝和其他角色仍使用代码图形。Windows原生、五人试玩、完整正式美术、Steam商店与上传均未完成。
