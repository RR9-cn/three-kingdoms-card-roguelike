...
- [x] 3.1 Update design documentation and browser coverage for the complete interaction.
- [x] 3.2 Run strict OpenSpec, rule, browser and desktop validation; rebuild macOS and Windows packages.
- [x] 3.3 Launch the packaged macOS prototype and commit and push the change.
