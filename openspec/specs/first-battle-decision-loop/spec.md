# first-battle-decision-loop Specification

## Purpose
Ensure the opening battle teaches retain, refill, and multi-hand decision making within the normal campaign rules.
## Requirements
