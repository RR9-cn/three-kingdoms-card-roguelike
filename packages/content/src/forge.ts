...
export const COMPANIONS={
 ...
 liubei:{name:'刘备',mark:'刘',role:'逐牌',price:10,text:'每张点数不大于4的牌计分时，+10兵力、+1倍率。',hint:'低点牌也可以成为构筑核心。',effect:'low-card'},
 zhouyu:{name:'周瑜',mark:'周',role:'兵种',price:10,text:'出牌至少两张同兵种，+3倍率。',hint:'对子和连阵也能受益，不必等待同袍。',effect:'two-suit'},
 zhaoyun:{name:'赵云',mark:'赵',role:'成长',price:10,text:'打出连阵或同袍连阵，本组件永久 +2 倍率。',hint:'配合兵书扩展连阵的组成方式。',effect:'straight-growth'},
 huangzhong:{name:'黄忠',mark:'黄',role:'逐牌',price:9,text:'每张点数不小于7的牌计分时，+18兵力。',hint:'升点、复制和重触发共同放大高点牌。',effect:'high-chips'},
 zhugeliang:{name:'诸葛亮',mark:'诸',role:'重触发',price:14,text:'最右侧出牌额外计分一次。',hint:'出牌按手牌槽位排序；可用箭头调整组件顺序。',effect:'last-repeat'},
 ...
 drum:{name:'合击战鼓',mark:'鼓',role:'基础',price:7,text:'出牌含对子，+30兵力。',hint:'提供前期强度，之后再考虑是否腾位置。',effect:'pair-chips'},
 ...
 abacus:{name:'精兵简册',mark:'简',role:'精简',price:8,text:'牌库少于36张时，每少一张，+6兵力。',hint:'删牌既改善抽牌稳定性，也提高攻势。',effect:'thin-deck'},
...
export const STAGES=[
 {name:'初出茅庐',enemy:'黄巾前哨',target:140,rule:'none',text:'四次出牌内积累足够攻势。'},
 {name:'长坂试锋',enemy:'黄巾游骑',target:300,rule:'none',text:'组牌、招募与整编的成果开始显现。'},
 {name:'虎牢列阵',enemy:'铁甲先锋',target:650,rule:'high-armor',text:'铁甲：点数7–9的牌基础点数按0计；逐牌组件仍生效。'},
 {name:'地公设坛',enemy:'张宝 · 地公将军',target:1400,rule:'ambush',text:'首领张宝：前40%兵力为伏击，换牌解除本手减伤；之后转入疑阵，连续同牌型攻势减半。'},
 {name:'官渡鏖兵',enemy:'黄巾督军',target:2500,rule:'none',text:'高目标检验成长与倍率的积累。'},
 {name:'赤壁逆风',enemy:'雷鼓祭司',target:3800,rule:'variety',text:'疑阵：连续打出相同牌型时，最终攻势减半。'},
 {name:'破军前夜',enemy:'黄巾渠帅',target:5600,rule:'flank',text:'渠帅识阵：首张出牌兵种与上一手相同时，攻势减半。改变首牌兵种可绕过。'},
 {name:'苍天已死',enemy:'张角',target:8000,rule:'last-stand',text:'终局张角：仅3次出牌。击破40%兵力后唤雷；出牌后手中未留下谋牌，攻势×0.6。'},
] as const;
export type ForgeEdit='remove'|'copy'|'rank'|'enhance'|'suit'|'level';
export const EDITS:Record<ForgeEdit,{name:string;text:string}>={remove:{name:'裁军',text:'永久删除一张牌，最低12张。'},copy:{name:'募兵',text:'复制一张牌，保留点数、兵种与强化。'},rank:{name:'练兵',text:'一张牌点数 +2，上限9。'},enhance:{name:'精锐',text:'一张牌每次计分额外 +12兵力。'},suit:{name:'改编',text:'永久改变一张牌的兵种。'},level:{name:'研习',text:'指定牌型等级 +1：基础兵力 +10、倍率 +1。'}};
