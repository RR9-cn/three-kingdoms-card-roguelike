...
const preferences:Record<string,CompanionId[]>={guanyu:['guanyu','zhangfei','blade','huangzhong','drum','granary','zhugeliang','zhouyu','oath','liubei','sunquan','simayi'],zhouyu:['zhouyu','oath','diaochan','zhugeliang','granary','liubei','scroll','zhaoyun','simayi','sunquan'],liubei:['liubei','zhugeliang','zhouyu','oath','granary','sunquan','zhangfei','guanyu','simayi','scroll']};
